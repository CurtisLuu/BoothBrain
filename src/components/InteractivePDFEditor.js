...
import { 
  ...
  Move, Square as SquareIcon, Circle as CircleIcon, Triangle, MousePointer2
} from 'lucide-react';
...
const InteractivePDFEditor = ({ file, onClose, onSave }) => {
  ...
  const loadPDF = async (file) => {
    ...
    try {
      ...
      // Also load with pdf-lib for editing
  ...
  const renderPDFPage = async (pdf, pageIndex) => {
    ...
    try {
      ...
      // Store the PDF image data for reference
      setPdfImageData(canvas.toDataURL());
    ...
    annotations.forEach(annotation => {
      ...
      switch (annotation.type) {
        case 'text':
          ...
          context.font = `${annotation.size || 12}px Arial`;
          context.fillText(annotation.text, annotation.x, annotation.y);
          break;
          
        case 'sticky-note':
          context.fillStyle = annotation.color || '#FFD700';
          context.fillRect(annotation.x, annotation.y, 100, 60);
          context.fillStyle = '#000000';
          context.font = '10px Arial';
          context.fillText(annotation.text || 'Note', annotation.x + 5, annotation.y + 15);
          break;
          
        case 'highlight':
          context.globalAlpha = 0.3;
          context.fillStyle = annotation.color || '#FFFF00';
          context.fillRect(annotation.x, annotation.y, annotation.width || 100, annotation.height || 20);
      ...
      if (selectedAnnotation && selectedAnnotation.id === annotation.id) {
        ...
        context.strokeRect(annotation.x - 5, annotation.y - 5, 
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg w-full h-full max-w-7xl max-h-screen flex flex-col">
        ...
        <div className="flex items-center justify-between p-4 border-b border-gray-200 dark:border-gray-700">
          <div className="flex items-center space-x-4">
            <h2 className="text-xl font-bold text-gray-900 dark:text-white">Interactive PDF Editor</h2>
          ...
          <div className="w-72 bg-gray-50 dark:bg-gray-700 p-4 space-y-6 overflow-y-auto">
            ...
            <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-3">
              ...
              <ul className="text-xs text-blue-800 dark:text-blue-200 space-y-1">
                ...
                <li>• <strong>Note:</strong> Click to add sticky notes</li>
